...
class World(object):
    ...
    def restart(self, args):
        ...
        while self.player is None:
            ...
            spawn_point = spawn_points[spawn_id] if spawn_points else carla.Transform()    
            self.player = self.world.try_spawn_actor(blueprint, spawn_point)
            self.modify_vehicle_physics(self.player)
...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        List=[transform.location.x, transform.location.y,3.6 * math.sqrt(vel.x**2 + vel.y**2 + vel.z**2)]
        with open('trajectory-'+str(trajectory_id)+'.csv', 'a') as f_object:
    ...
    try:
        ...
        for w in waypoints:
            ...
            for traffic_light in traffic_lights:
                ...
                traffic_light.set_green_time(400)
